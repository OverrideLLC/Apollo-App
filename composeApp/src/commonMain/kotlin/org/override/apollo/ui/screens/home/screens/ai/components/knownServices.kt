...
import apollo_app.composeapp.generated.resources.arrow_upward_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24
import apollo_app.composeapp.generated.resources.attach_file_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24
...
internal fun TextFieldAi(
    ...
    val sendEnabled =
        (value.text.isNotBlank()) && !state.isLoading
        ...
        Box(modifier = Modifier.weight(1f)) {
                        ...
                        IconButton(
                            ...
                            Crossfade(
                                ...
                                if (isLoading) {
                                    ...
                                    Icon( // Especificando M3 Icon
                                        painter = painterResource(Res.drawable.arrow_upward_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24),
            ...
            DropdownMenu( // androidx.compose.material.DropdownMenu (o cambia a material3 si es necesario)
                ...
                filteredServices.forEach { service ->
                    ...
                    DropdownMenuItem( // o material3.DropdownMenuItem
